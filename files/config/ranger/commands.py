...
class unmount(Command):
    """
    Unmounts a mountpoint directory
    """
    def execute(self):
        import os.path
        import dbus
        ...
        bus = dbus.SystemBus()
        ud_manager_obj = self.bus.get_object(UDISKS_OBJECT, UDISKS_OBJECT_PATH)
        ud_manager = dbus.Interface(self.ud_manager_obj, UDISKS_OBJECT)
